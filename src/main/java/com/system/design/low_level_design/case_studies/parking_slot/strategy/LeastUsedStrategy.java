...
import com.system.design.low_level_design.case_studies.parking_slot.repositories.TicketRepository;
...
public class LeastUsedStrategy implements SlotAllocationStrategy {
    ...
    private long usageCount(String slotId) {
        ...
        return ticketRepository.findByStatus(com.system.design.low_level_design.case_studies.parking_slot.enums.TicketStatus.CLOSED)
                .stream()
